...
export const TargetNeed: React.FC<{ match: Match, type: 'TARGET' | 'NEED' }> = ({ match, type }) => {
  ...
  if (type === 'TARGET') {
    return (
      ...
      >
        <div className="broadcast-gradient-primary p-8 flex flex-col items-center justify-center border-r border-white/10">
        ...
        <div className="p-8 flex flex-col justify-center bg-slate-900/95 min-w-[300px]">
  ...
  return (
    ...
    >
      <div className="broadcast-gradient-accent p-8 flex flex-col items-center justify-center border-r border-white/10">
      ...
      <div className="p-8 flex flex-col justify-center bg-slate-900/95">
