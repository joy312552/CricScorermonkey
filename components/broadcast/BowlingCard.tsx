...
export const BowlingCard: React.FC<{ match: Match }> = ({ match }) => {
    ...
    >
      <div className="w-[90%] max-w-5xl bg-gradient-to-br from-[#0A1128] to-[#1A237E] rounded-lg overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.8)] border-2 border-white/10 relative">
        ...
        <div className="relative z-10 p-8 pl-24 pr-12">
          ...
          {/* Table Header */}
          <div className="bg-[#00A8E8] flex items-center py-2 px-4 mb-2 shadow-inner border-y border-white/20">
            ...
            {bowlers.map((bowler, idx) => (
              <div key={idx} className="flex items-center py-2 px-4 text-white font-black text-xl uppercase tracking-tighter hover:bg-white/5 transition-colors">
                ...
                <div className="flex gap-8">
                  ...
                  <span className="w-16 text-center text-cyan-400">{bowler.wkts}</span>
